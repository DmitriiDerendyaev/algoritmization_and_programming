...
//вопросы: почему я не могу заполнить n1 и n2 внутри подфункции? 
//они стали хранить правильные значения размеров только после того, как я объвил и заполнил их глобально...

// в чем проблема работы цикла task_while?
//я реализую программу почти по образцу и с учетом рабочего task_for все очень странно...